...
noborder <- fp_border(width = 0)
std_border = fp_border(color="black", width = 1)
colkeys = c("Rain", "Control", "Treatment", "no3ctl", "no3trt", "orthoctl", "orthotrt", "tssctl", "tsstrt")
...
complete <- flextable(sitecomplete) %>% 
  ...
  colformat_num(col_keys = colkeys, digits = 2, na_str = "NA") %>%
  set_header_labels(Year = "Year", Rain = "Rain", Control = "Control", Treatment = "Treatment", no3ctl = "Control", no3trt = "Treatment", orthoctl = "Control", orthotrt = "Treatment", tssctl = "Control", tsstrt = "Treatment") %>%
